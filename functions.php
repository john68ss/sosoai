...
function cryptozfree_scripts() {
	...
	wp_enqueue_style( 'cryptozfree-post-style', get_template_directory_uri() . '/assets/css/post-style.css', array(), VERSION , 'all');
	wp_enqueue_style( 'cryptozfree-default-style', get_template_directory_uri() . '/assets/css/theme-default.css', array(), VERSION , 'all');
	wp_enqueue_style( 'cryptozfree-woocommerce-default-style', get_template_directory_uri() . '/assets/css/woocommerce-default.css', array(), VERSION , 'all');


	wp_enqueue_script( 'cryptozfree-navigation', get_template_directory_uri() . '/js/navigation.js', array(), VERSION, true );
